...
export const PERSONAL_PROJECTS = [
    ...
    },
    {
        ...
        date: '2024',
        description:
            'An automated end-to-end data pipeline to analyze Toronto Bikeshare usage patterns. Features data ingestion via API, storage in GCP, BigQuery transformations, and Looker Studio visualizations.',
        tech: 'Kestra, GCP, BigQuery, Docker, Looker Studio',
        link: 'https://github.com/Yusufislam-id/Toronto-Bikeshare-Pipeline'
    }
];
